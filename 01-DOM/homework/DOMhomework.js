...
// Tu código acá:
document.querySelector("#createdBy").innerHTML += " Haru";
...
function displayToDos() {
  ...
  let toDobuild = buildToDos(toDoItems);
  for(let i = 0; i < toDobuild.length; i++ ){
    toDoContainer.appendChild(toDobuild[i]);  
  }
}
